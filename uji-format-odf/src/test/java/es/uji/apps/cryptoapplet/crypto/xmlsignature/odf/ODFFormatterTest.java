...
public class ODFFormatterTest
{
    public static void main(String[] args) throws Exception
    {
        ...
        ODFFormatter odfSignatureFactory = new ODFFormatter();
        SignatureResult signatureResult = odfSignatureFactory.format(signatureOptions);
        ...
        if (signatureResult.isValid())
        {
            ...
            odfSignatureFactory = new ODFFormatter();
            signatureResult = odfSignatureFactory.format(signatureOptions);
