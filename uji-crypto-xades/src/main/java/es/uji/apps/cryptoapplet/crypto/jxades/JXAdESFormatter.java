...
public class JXAdESFormatter implements Formatter
{
    @Override
            ...
            throws CryptoAppletCoreException
    {
        ...
        try
        {
            ...
            String tsaUrl = conf.getTimestampingServicesRegistry().getTimestampingServices().get(0)
                    .getUrl();
            ...
            try
            {
                ...
                if (signatureOptions.isEnveloped() && signatureOptions.isCoSignEnabled())
                {
                    ...
                    xmlSignature.sign(certificate, privateKey, SignatureMethod.RSA_SHA1,
                            Arrays.asList(new Object[] { reference }), "S" + numSignature, tsaUrl);
                }
                else
                {
                    xmlSignature.sign(certificate, privateKey, SignatureMethod.RSA_SHA1,
                            references, "S" + numSignature, tsaUrl);
                }
            }
