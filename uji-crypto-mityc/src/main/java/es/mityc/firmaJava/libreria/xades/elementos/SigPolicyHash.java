...
public class SigPolicyHash extends DigestAlgAndValueType {
	...
	public SigPolicyHash(XAdESSchemas schema, DigestAlgAndValueType daaavt) {
		super(schema, daaavt.getMethod().getAlgorithm(), daaavt.getValue().getValue());
	}
	
	/**
	 * @see es.mityc.firmaJava.libreria.xades.elementos.DigestAlgAndValueType#load(org.w3c.dom.Element)
	 */
	@Override
	...
	/**
	 * @see es.mityc.firmaJava.libreria.xades.elementos.DigestAlgAndValueType#isThisNode(org.w3c.dom.Node)
	 */
	@Override
	...
	/**
	 * @see es.mityc.firmaJava.libreria.xades.elementos.DigestAlgAndValueType#createElement(org.w3c.dom.Document)
	 */
	@Override
