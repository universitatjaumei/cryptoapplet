 ...
 * @version 0.9 beta
 */
public class ConfiguracionMozillaException extends FirmaXMLError{
	 /**
     * Crea una nueva instancia de FirmaXMLError sin el mensaje de detalle.
     */
    public ConfiguracionMozillaException() {
    }
     ...
     */
    public ConfiguracionMozillaException(String msg) {
        super(msg);
    }
     ...
     * @param e Exception
     */
     public ConfiguracionMozillaException(Exception e) {
        super(e);
    }
	 ...
	 * @param cause
	 */
	public ConfiguracionMozillaException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause
	 */
	public ConfiguracionMozillaException(Throwable cause) {
		super(cause);
	}
}
