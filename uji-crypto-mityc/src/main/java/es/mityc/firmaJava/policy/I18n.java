...
public class I18n {
	...
	private static Locale locale = new Locale(ConstantesFacturaePolicy.ES_MINUSCULA,ConstantesFacturaePolicy.ES_MAYUSCULA);
    ...
    public static String getResource(String key,Locale locale){
        return ResourceBundle.getBundle(ConstantesFacturaePolicy.NOMBRE_LIBRERIA,locale).getString(key) ;
    }
    /**
     ...
     */
    public static void setLocale(String country, String dialect) {
