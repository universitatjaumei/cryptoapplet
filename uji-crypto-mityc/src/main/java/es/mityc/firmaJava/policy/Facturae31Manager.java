...
/**
 * Implementación de la política de factura electrónica v 3.1:
 * http://www.facturae.es/politica de firma formato facturae/politica de firma formato facturae v3_1.pdf
 * 
...
public class Facturae31Manager extends FacturaeManager {
	...
	private final static Log logger = LogFactory.getLog(Facturae31Manager.class);
