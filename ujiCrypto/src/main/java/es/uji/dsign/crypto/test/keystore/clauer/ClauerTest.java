package es.uji.dsign.crypto.test.keystore.clauer;
		...
		if (clr.isRunTimeRunning())
		{
			try
			{
				...
				if (devs.length > 0)
				{
					...
					System.out.println(cl.getCertificate("a165612e9aaa1c2dd4ece0acd1b526d35420c997"));
					cl.close();
					...
					{
						System.out.println("\nOpen Auth OK");
						System.out.println("Llave: " + cl.getPrivateKey("a165612e9aaa1c2dd4ece0acd1b526d35420c997"));
					}
					else
					{
