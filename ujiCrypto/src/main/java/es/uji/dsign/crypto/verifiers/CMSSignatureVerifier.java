...
public class CMSSignatureVerifier {
	...
	// .
	private boolean verifyCMS(CMSSignedData aSignedData)
	throws CMSException,
	...
	private boolean verifyCAandSignature(byte[] aDataBytes, byte[] aSignature)
	throws CMSException,
	NoSuchProviderException,
	NoSuchAlgorithmException,
	CertStoreException,
	...
	CertificateExpiredException {
		...
		CMSSignedData cmsSd =
			new CMSSignedData(cmsByteArray, aSignature);
	...
	public static void main(String[] args) {
		...
		try{
			...
			CMSSignatureVerifier pv= new CMSSignatureVerifier(caPaths.toArray(x),new FileInputStream(dataFile), new FileInputStream(cmsFile));
