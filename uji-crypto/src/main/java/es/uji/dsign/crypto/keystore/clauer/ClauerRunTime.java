...
import es.uji.dsign.crypto.keystore.clauer.ClauerHandle;
...
/**
 * This class will implement all the functions of the protocol by the time it
 * will implement just the necessary ones
 */
...
public class ClauerRunTime
{
	...
	public String[] enumerateDevices() throws IOException, Exception
	{
		...
		while (i < numDev)
		{
			...
			/*
			 * Client sends little endian data, readInt function represents the
			 * integer as big endian so we must reverse the bytes.
			 */
	...
	public boolean startSession(String device, String pwd, ClauerHandle clHandle) throws IOException
	{
		int err;
