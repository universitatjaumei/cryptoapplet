...
public class X509TestHelper
{
    ...
    public static void  initialize()
    {
        ...
        try{
            ...
            clientPrivKey = fact.generatePrivate(privKeySpec);
            clientPubKey = fact.generatePublic(pubKeySpec);
            ...
            //
            caCert = createAcIssuerCert(caPubKey, caPrivKey);
            clientCert = createClientCert(clientPubKey, caPrivKey, caPubKey);
    ...
    public static PublicKey  getClaPublicKey(){
        if (!init)
            initialize();
    ...
    public static void main(String[] args){
        ...
        System.out.println("Certificado cliente: " + X509TestHelper.getClientCert());
        System.out.println("Certificado ca: " + X509TestHelper.getCaCert());
        
        System.out.println("Client Private Key: " + X509TestHelper.getClientPrivateKey());
        System.out.println("Client Private Key: " + X509TestHelper.getCaPrivateKey());
