...
public class CMSTSSignatureVerifier
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            {
                System.err
                        .println("Uso: CMSSignatureVerifier -tsa0 root_tsa_ca -tsa1 root_tsa_level2_ca ... -ca0 root_ca -ca1 level2_ca -ca2 level3_ca ... -data data.txt -cms cms.pem");
                System.exit(-1);
            }
            int n_ca = 0;
            int n_tsa_ca = 0;
            ...
            String sig = straux.substring(straux.indexOf("<cms_signature>" + 15), straux
                    .indexOf("</cms_signature>"));
            String ts = straux.substring(straux.indexOf("<cms_timestamp>" + 15), straux
                    .indexOf("</cms_timestamp>"));
            ...
            CMSSignatureVerifier pv = new CMSSignatureVerifier(caPaths.toArray(x),
                    new FileInputStream(dataFile), bsig);
            ...
            System.out.println("Resultado verificacion Firma: "
                    + verifyTS(tsaPaths.toArray(x), bsig, bts));
        }
        catch (Exception e)
        {
            e.printStackTrace();
