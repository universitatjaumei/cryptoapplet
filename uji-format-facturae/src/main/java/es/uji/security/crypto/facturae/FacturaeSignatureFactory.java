...
public class FacturaeSignatureFactory implements ISignFormatProvider
{
    public SignatureResult formatSignature(SignatureOptions signatureOptions) throws Exception
    {
        ...
        Document document  = documentBuilder.parse(signatureOptions.getDataToSign());
        
        NodeList result = document.getElementsByTagNameNS("http://www.w3.org/2000/09/xmldsig#", "Signature");
        ...
        signatureOptions.setPolicyIdentifier("http://www.facturae.es/politica_de_firma_formato_facturae/politica_de_firma_formato_facturae_v3_1.pdf");
        signatureOptions.setPolicyDescription("Pol\u00edtica de firma electr\u00f3nica para facturaci\u00f3n electr\u00f3nica con formato Facturae");
