...
public class RawSignatureVerifier
{
    ...
    public static boolean verify(InputStream dataStream, InputStream signature,
            InputStream certStream) throws CertificateException, IOException,
        ...
        try
        {
            ...
            else
            {
                ...
                System.out.println("El resultado es: "
                        + RawSignatureVerifier.verify(datafis, fis, inStream));
