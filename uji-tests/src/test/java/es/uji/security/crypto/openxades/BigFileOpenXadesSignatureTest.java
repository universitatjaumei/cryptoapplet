...
public class BigFileOpenXadesSignatureTest
{
    ...
    public void signAndVerify(String file, String pwd) throws Exception
    {
        ...
        Signature sig = sdoc.prepareSignature((X509Certificate) certificate,
                new String[] { "a Role" }, null);
        ...
        byte[] completeCertificateRefs = sig.getUnsignedProperties().getCompleteCertificateRefs()
                .toXML();
