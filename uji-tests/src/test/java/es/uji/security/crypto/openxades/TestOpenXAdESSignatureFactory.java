...
public class TestOpenXAdESSignatureFactory
{
    public static void main(String[] args) throws Exception
    {
        ...
        keystore.load(new FileInputStream("/home/paul/tmp/mio.p12"), pin.toCharArray());
        ...
        VerificationResult verificationDetails = verifier
                .verify(OS.inputStreamToByteArray(new FileInputStream(
                        "src/main/resources/signed-output.xml")));
