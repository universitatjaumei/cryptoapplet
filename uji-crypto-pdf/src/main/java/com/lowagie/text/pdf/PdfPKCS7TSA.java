...
public class PdfPKCS7TSA {
     ...
     */    
    public PdfPKCS7TSA(byte[] contentsKey, byte[] certsKey, String provider) throws SecurityException, InvalidKeyException, CertificateException, NoSuchProviderException, NoSuchAlgorithmException, IOException, StreamParsingException, org.bouncycastle.x509.util.StreamParsingException {
     ...
     * @throws org.bouncycastle.x509.util.StreamParsingException 
     */    
    public PdfPKCS7TSA(byte[] contentsKey, String provider) throws SecurityException, CRLException, InvalidKeyException, CertificateException, NoSuchProviderException, NoSuchAlgorithmException, StreamParsingException, org.bouncycastle.x509.util.StreamParsingException {
