 ...
 * data) and signed and unsigned properties.
 * 
...
public class Signature implements Serializable
{
     ...
     * 
     * @param sigDoc
     *            new value for sigDoc attribute
     */
     ...
     * 
     * @param str
     *            new value for origContent attribute
     */
     ...
     * 
     * @param str
     *            new value for signedInfo attribute
     * @throws DigiDocException
     *             for validation errors
     */
     ...
     * 
     * @param str
     *            new value for signatureValue attribute
     * @throws DigiDocException
     *             for validation errors
     */
     ...
     * 
     * @param str
     *            new value for keyInfo attribute
     * @throws DigiDocException
     *             for validation errors
     */
     ...
     * 
     * @param str
     *            new value for signedProperties attribute
     * @throws DigiDocException
     *             for validation errors
     */
     ...
     * 
     * @param str
     *            new value for unsignedProperties attribute
     * @throws DigiDocException
     *             for validation errors
     */
    ...
    /**
     * Retrieves CertValue element with the desired type. If not found creates a new one with this
     * type.
     * 
     * @param type
     *            CertValue type
    ...
    /**
     * Returns the first CertValue with the given serial number that has been attached to this
     * signature in digidoc document. This could be either the signers cert, OCSP responders cert or
     * one of the TSA certs.
     * 
     * @param serNo
    ...
    /**
     * Retrieves TimestampInfo element with the desired type. If not found creates a new one with
     * this type.
     * 
     * @param type
     *            TimestampInfo type
    ...
    /**
     * Gets confirmation and adds the corresponding members that carry the returned info to this
     * signature
     * 
     * @throws DigiDocException
     *             for all errors
    ...
    public void getConfirmation() throws DigiDocException
    {
        ...
        {
            m_logger
                    .info("ERROR: Cannot find the CAs certificate for signer's certificate with DN: "
                            + cert.getSubjectDN());
        ...
        X509Certificate rcert = notFac.getNotaryCert(rrefs.getResponderCommonName(), not
                .getCertNr());
    ...
    public ArrayList verify(SignedDoc sdoc, boolean checkDate, boolean demandConfirmation)
    {
        ...
        for (int i = 0; i < sdoc.countDataFiles(); i++)
        {
            ...
            if (ref != null)
            {
                // System.out.println("Compare it to: " + Base64Util.encode(ref.getDigestValue(),
                // 0));
        ...
        try
        {
            ...
            // System.out.println("SignedInfo real digest: " + Base64Util.encode(dig, 0) + " hex: "
            // + SignedDoc.bin2hex(dig));
        ...
        {
            if (checkDate)
                m_keyInfo.getSignersCertificate().checkValidity(m_sigProp.getSigningTime());
        }
        catch (Exception ex)
        {
            errs.add(new DigiDocException(DigiDocException.ERR_CERT_EXPIRED,
        ...
        if (m_timestamps != null && m_timestamps.size() > 0)
        {
            ...
            if (dt1 == null)
            {
                errs.add(new DigiDocException(DigiDocException.ERR_TIMESTAMP_VERIFY,
                        "Cannot retrieve SignatureTimeStamp", null));
            }
            else
            {
                ...
                if (dt2 != null)
                {
                    ...
                    if (do1.before(dt1) || do1.after(dt2))
                        errs
                                .add(new DigiDocException(
                                        DigiDocException.ERR_TIMESTAMP_VERIFY,
                                        "OCSP time is not between SignAndRefsTimeStamp and SignatureTimeStamp",
                                        null));
                }
                else
                {
    ...
    /**
     * Verifies this signature. Demands either OCSP confirmation or uses CRL to check signature
     * validity.
     * 
     * @param sdoc
     *            parent doc object
        ...
        if (m_origContent == null)
        {
            ...
            try
            {
                ...
                if (m_sigDoc.getVersion().equals(SignedDoc.VERSION_1_3))
                {
                    ...
                    // in versions prior to 1.3 we used atributes in wrong places
