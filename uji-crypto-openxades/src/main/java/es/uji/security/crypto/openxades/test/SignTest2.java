...
//            DataFile df = sdoc.addDataFile(new File("/tmp/f"), "application/binary",
//                    DataFile.CONTENT_DETATCHED /* .CONTENT_EMBEDDED_BASE64 */);
...
//
//            /*
//             * // Obtenemos el timestamp y lo añadimos TimeStampRequestGenerator reqGen = new
//             * TimeStampRequestGenerator();
//             * 
//             * // Request TSA to return certificate reqGen.setCertReq(false);
//             * 
...
//             * 
//             * TimeStampRequest request = reqGen.generate(TSPAlgorithms.SHA1, hash); byte[] enc_req
//             * = request.getEncoded();
//             * 
//             * String tsaUrl= ConfigManager.instance().getProperty("DIGIDOC_TSA1_URL"); URL url =
//             * new URL(tsaUrl);
//             * 
//             * URLConnection urlConn = url.openConnection(); urlConn.setDoInput(true);
//             * urlConn.setDoOutput(true); urlConn.setUseCaches(false);
//             * 
...
//             * 
//             * OutputStream printout = urlConn.getOutputStream(); printout.write(enc_req);
...
//             * ts.setTimeStampResponse(resp); ts.setSignature(sig);
...
//             * 
//             * CertValue cval = new CertValue(); cval.setType(CertValue.CERTVAL_TYPE_TSA);
//             * cval.setCert(xcaCert); cval.setId(sig.getId() + "-TSA_CERT");
//             */
//
...
//             * System.getProperty("file.separator") + "data.ddoc"; sdoc.writeToFile(new
//             * File(xadesFile));
//             * 
//             * // Verificamos el documento creado DigiDocFactory digFac =
//             * ConfigManager.instance().getDigiDocFactory(); sdoc = digFac.readSignedDoc(xadesFile);
//             * 
//             * for (int i=0 ; i<sdoc.countSignatures() ; i++) { sig = sdoc.getSignature(i);
...
//             * 
//             * if(errs.size() == 0) { System.out.println("XAdES document is correct!!!"); } else {
//             * for (int j=0 ; j<errs.size() ; j++) { System.out.println("JDigidoc Error: " +
//             * (DigiDocException) errs.get(i)); } } } }
//             */
//
//        }
//        catch (Exception e)
