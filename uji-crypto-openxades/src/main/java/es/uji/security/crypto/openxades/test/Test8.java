...
import java.io.*;
import java.security.cert.X509Certificate; //import ee.sk.digidoc.factory.*;
//import java.util.*;
...
public class Test8
{
    ...
    {
        /*
         * if(args.length != 2) { System.out.println("USAGE: Test8 <config-file> <cert>"); return; }
         */
        try
        {
            ...
            /*
             * System.out.println("Init NotaryFactory"); NotaryFactory notFac = ConfigManager.
             * instance().getNotaryFactory(); System.out.println("Checking certificate");
