package es.uji.security.keystore.dnie.test;
...
{
    public static void main(String[] args) throws KeyStoreException, ClassNotFoundException, SecurityException, NoSuchMethodException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException
    {
