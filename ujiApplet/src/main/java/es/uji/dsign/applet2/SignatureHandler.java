...
public class SignatureHandler {
	...
	/* That function is the one invoked by the signature thread once 
	 * the signature process has finalized, if there are more signatures 
	 * on the inputParams stack, the signature thread is instantiated again
	 * */
