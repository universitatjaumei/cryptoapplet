...
public class MainWindow {
	...
	public MainWindow(AppHandler aph) 
	throws Exception {
		_aph= aph;	
	...
	throws Exception {
		if (certificateJTreeScrollPane == null) {
			...
			certificateJTreeScrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
		}
	 ...
	 * @return javax.swing.JScrollPane	
	 */
	protected void reloadCertificateJTree() 
	throws Exception {
		jTree= null;
		certificateJTreeScrollPane.setViewportView(getJTree());
	 ...
	 * @deprecated
	 * 
	 * Init the indeterminate progress on the main window
	 * for version 1.
	 *
	 */
